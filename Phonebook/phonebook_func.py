...
def center_window(self, w, h): #pass in the tkinter frame (master) references and the w and h
...
def onDeleted(self):
    ...
    self.txt_phone.delete(0,END)
    self.txt_email.delete(0,END)
    ## on refresh(self) # update list box of changes
    try:
...
def onRefresh(self):
    #popuplate the list box, coinciding with the database
